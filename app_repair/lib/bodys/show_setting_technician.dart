...
class ShowSettingTechnician extends StatefulWidget {
  ...
  const ShowSettingTechnician({Key? key, required this.userModel})
      : super(key: key);

  @override
  _ShowSettingTechnicianState createState() => _ShowSettingTechnicianState();
}

class _ShowSettingTechnicianState extends State<ShowSettingTechnician> {
  UserModel? userModel;
